class Permission < BaseModel
  ...
  validates :jarjestys, uniqueness: { scope: [:yhtio, :user, :kuka, :sovellus, :jarjestys2, :profiili] }
  validates :nimi, presence: true, uniqueness: { scope: [:yhtio, :user, :kuka, :sovellus, :alanimi, :profiili] }
