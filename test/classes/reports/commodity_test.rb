...
class Reports::CommodityTest < ActiveSupport::TestCase
  ...
  test 'returns response hierarcy' do
    ...
    assert_equal "0.0", data.closing_deprication.to_s
    assert_equal "0.0", data.opening_btl.to_s
    assert_equal "1001.0", data.closing_btl.to_s
    assert_equal "0.0", data.opening_difference.to_s
    assert_equal "111.0", data.closing_difference.to_s
    ...
    assert_equal "0.0", data.additions_in_range.to_s
    assert_equal "0.0", data.deductions_in_range.to_s
    assert_equal "10000.0", data.opening_procurement_amount.to_s
    assert_equal "10000.0", data.closing_procurement_amount.to_s
    ...
    assert_equal "0.0", sum_level.closing_deprication.to_s
    assert_equal "0.0", sum_level.opening_btl.to_s
    assert_equal "1001.0", sum_level.closing_btl.to_s
    assert_equal "0.0", sum_level.opening_difference.to_s
    assert_equal "111.0", sum_level.closing_difference.to_s
    ...
    assert_equal "0.0", sum_level.additions_in_range.to_s
    assert_equal "0.0", sum_level.deductions_in_range.to_s
    assert_equal "10000.0", sum_level.opening_procurement_amount.to_s
    assert_equal "10000.0", sum_level.closing_procurement_amount.to_s
    ...
    assert_equal "0.0", account.closing_deprication.to_s
    assert_equal "0.0", account.opening_btl.to_s
    assert_equal "1001.0", account.closing_btl.to_s
    assert_equal "0.0", account.opening_difference.to_s
    assert_equal "111.0", account.closing_difference.to_s
    ...
    assert_equal "0.0", account.additions_in_range.to_s
    assert_equal "0.0", account.deductions_in_range.to_s
    assert_equal "10000.0", account.opening_procurement_amount.to_s
    assert_equal "10000.0", account.closing_procurement_amount.to_s
