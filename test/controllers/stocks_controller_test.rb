...
class StocksControllerTest < ActionController::TestCase
  ...
  test 'stock available with sku' do
    params = {
      product_sku: @product.tuoteno,
      warehouse_ids: @warehouse_ids,
      access_token: @api_key,
    }
  ...
  test 'stock available with no product info' do
    params = {
      warehouse_ids: @warehouse_ids,
      access_token: @api_key,
    }
  ...
  test 'stock available with invalid product info' do
    params = {
      warehouse_ids: @warehouse_ids,
      product_id: -1,
      access_token: @api_key,
