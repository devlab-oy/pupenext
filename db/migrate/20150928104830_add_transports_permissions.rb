class AddTransportsPermissions < ActiveRecord::Migration
  def up
    Company.find_each do |company|
      ...
      Permission.create!(
        kuka: '',
        sovellus: 'Ylläpito',
        nimi: 'pupenext/transports',
        nimitys: 'Tiedonsiirtoyhteydet',
        laatija: 'admin',
  ...
  def down
    Company.find_each do |company|
      ...
      Permission.where(nimi: 'pupenext/transports').delete_all
    end
  end
end
