...
ActiveRecord::Schema.define(version: 0) do
  ...
  add_index "abc_aputaulu", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  add_index "abc_aputaulu", ["yhtio", "tyyppi", "luokka", "summa"], name: "yhtio_tyyppi_luokka"
  add_index "abc_aputaulu", ["yhtio", "tyyppi", "osasto", "try"], name: "yhtio_tyyppi_osasto_try"
  add_index "abc_aputaulu", ["yhtio", "tyyppi", "try"], name: "yhtio_tyyppi_try"
  add_index "abc_aputaulu", ["yhtio", "tyyppi", "tuotemerkki"], name: "yhtio_tyyppi_tuotemerkki"
  add_index "abc_aputaulu", ["yhtio", "tyyppi", "tuoteno"], name: "yhtio_tyyppi_tuoteno"
  ...
  create_table "asiakas", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "laatija",                          limit: 10,                           default: "",  null: false
    t.string   "lahetetyyppi",                     limit: 50,                           default: "",  null: false
  ...
  add_index "asiakas", ["nimi"], name: "asiakasnimi"
  add_index "asiakas", ["nimitark"], name: "asiakasnimitark"
  add_index "asiakas", ["toim_nimi"], name: "asiakastoim_nimi"
  add_index "asiakas", ["toim_nimitark"], name: "asiakastoim_nimitark"
  add_index "asiakas", ["yhtio", "asiakasnro"], name: "asno_index"
  add_index "asiakas", ["yhtio", "osasto", "ryhma"], name: "yhtio_osasto_ryhma"
  add_index "asiakas", ["yhtio", "ovttunnus"], name: "ovttunnus_index"
  add_index "asiakas", ["yhtio", "toim_ovttunnus"], name: "toim_ovttunnus_index"
  add_index "asiakas", ["yhtio", "ytunnus"], name: "ytunnus_index"
  ...
  add_index "asiakasalennus", ["yhtio", "asiakas", "ryhma"], name: "yhtio_asiakas_ryhma"
  add_index "asiakasalennus", ["yhtio", "asiakas", "tuoteno"], name: "yhtio_asiakas_tuoteno"
  add_index "asiakasalennus", ["yhtio", "asiakas_ryhma", "ryhma"], name: "yhtio_asiakasryhma_ryhma"
  add_index "asiakasalennus", ["yhtio", "asiakas_ryhma", "tuoteno"], name: "yhtio_asiakasryhma_tuoteno"
  add_index "asiakasalennus", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  add_index "asiakasalennus", ["yhtio", "ytunnus", "ryhma"], name: "yhtio_ytunnus_ryhma"
  add_index "asiakasalennus", ["yhtio", "ytunnus", "tuoteno"], name: "yhtio_ytunnus_tuoteno"
  ...
  add_index "asiakashinta", ["yhtio", "asiakas", "ryhma"], name: "yhtio_asiakas_ryhma"
  add_index "asiakashinta", ["yhtio", "asiakas", "tuoteno"], name: "yhtio_asiakas_tuoteno"
  add_index "asiakashinta", ["yhtio", "asiakas_ryhma", "ryhma"], name: "yhtio_asiakasryhma_ryhma"
  add_index "asiakashinta", ["yhtio", "asiakas_ryhma", "tuoteno"], name: "yhtio_asiakasryhma_tuoteno"
  add_index "asiakashinta", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  add_index "asiakashinta", ["yhtio", "ytunnus", "ryhma"], name: "yhtio_ytunnus_ryhma"
  add_index "asiakashinta", ["yhtio", "ytunnus", "tuoteno"], name: "yhtio_ytunnus_tuoteno"
  ...
  add_index "asiakaskommentti", ["yhtio", "ytunnus", "tuoteno"], name: "yhtio_ytunnus_tuoteno"
  ...
  create_table "asiakkaan_avainsanat", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "kieli",        limit: 2,  default: "", null: false
    t.string   "laatija",      limit: 10, default: "", null: false
    t.string   "laji",         limit: 25, default: "", null: false
    t.string   "muuttaja",     limit: 10, default: "", null: false
    t.string   "yhtio",        limit: 5,  default: "", null: false
    t.text     "avainsana"
    t.text     "tarkenne"
  ...
  add_index "asiakkaan_avainsanat", ["yhtio", "liitostunnus"], name: "yhtio_liitostunnus"

  create_table "asn_sanomat", primary_key: "tunnus", force: true do |t|
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    t.datetime "saapumispvm"
  ...
  add_index "avainsana", ["yhtio", "laji", "perhe", "kieli"], name: "yhtio_laji_perhe_kieli"
  add_index "avainsana", ["yhtio", "laji", "selite"], name: "yhtio_laji_selite"
  add_index "avainsana", ["yhtio", "laji", "selitetark"], name: "yhtio_laji_selitetark", length: {"yhtio"=>nil, "laji"=>nil, "selitetark"=>100}
  ...
  add_index "budjetti", ["yhtio", "taso", "kausi"], name: "yhtio_taso_kausi"
  ...
  add_index "budjetti_asiakas", ["yhtio", "kausi", "asiakkaan_tunnus", "osasto", "try"], name: "asbu", unique: true
  ...
  add_index "budjetti_myyja", ["yhtio", "kausi", "myyjan_tunnus", "osasto", "try"], name: "budjetti_myyja", unique: true
  ...
  add_index "budjetti_toimittaja", ["yhtio", "kausi", "toimittajan_tunnus", "osasto", "try"], name: "tobu", unique: true
  ...
  add_index "budjetti_tuote", ["yhtio", "kausi", "tuoteno", "osasto", "try"], name: "tubu", unique: true
  add_index "budjetti_tuote", ["yhtio", "tuoteno", "kausi"], name: "yhtio_tuote_kausi"
  ...
  add_index "dynaaminen_puu", ["yhtio", "laji", "koodi"], name: "yhtio_laji_koodi"
  add_index "dynaaminen_puu", ["yhtio", "laji", "lft"], name: "yhtio_laji_lft"
  add_index "dynaaminen_puu", ["yhtio", "laji", "rgt"], name: "yhtio_laji_rgt"

  create_table "etaisyydet", primary_key: "tunnus", force: true do |t|
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    t.integer  "km",                         null: false
    t.string   "laatija",         limit: 10, null: false
    t.string   "muuttaja",        limit: 10, null: false
    t.string   "postino",         limit: 15, null: false
    t.string   "postitp",         limit: 35, null: false
    t.string   "varasto_postino", limit: 15, null: false
    t.string   "yhtio",           limit: 5,  null: false
  end
  ...
  add_index "extranet_kayttajan_lisatiedot", ["yhtio", "liitostunnus", "laji", "selite"], name: "yhtio_liitostunnus_laji_selite", unique: true
  ...
  add_index "hinnasto", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  ...
  add_index "hyvityssaannot", ["yhtio", "aika_ostosta"], name: "yhtio_aika_ostosta"
  add_index "hyvityssaannot", ["yhtio", "tuote_kentta", "tuote_arvo"], name: "yhtio_tuote_kentta_tuote_arvo"
  ...
  create_table "kalenteri", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "kuka",            limit: 30, default: "",                    null: false
    t.string   "laatija",         limit: 30, default: "",                    null: false
    t.string   "muuttaja",        limit: 10, default: "",                    null: false
  ...
  add_index "kalenteri", ["yhtio", "kuka", "tyyppi", "pvmalku"], name: "yhtio_kuka_tyyppi_pvmalku"
  add_index "kalenteri", ["yhtio", "liitostunnus"], name: "yhtio_liitostunnus"
  add_index "kalenteri", ["yhtio", "tyyppi", "pvmalku"], name: "yhtio_tyyppi_pvmalku"
  add_index "kalenteri", ["yhtio", "tyyppi", "tapa", "pvmalku"], name: "tyyppi_tapa"
  ...
  add_index "karhu_lasku", ["ktunnus"], name: "ktunnus"
  add_index "karhu_lasku", ["ltunnus"], name: "ltunnus"
  ...
  create_table "kerayserat", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "keratty",        limit: 10,                           default: "",  null: false
    t.string   "laatija",        limit: 10,                           default: "",  null: false
    t.string   "muuttaja",       limit: 10,                           default: "",  null: false
    t.string   "ohjelma_moduli", limit: 50,                           default: "",  null: false
    t.string   "sscc_ulkoinen",  limit: 150,                          default: "0", null: false
    t.string   "tila",           limit: 1,                            default: "",  null: false
    t.string   "yhtio",          limit: 5,                            default: "",  null: false
  end

  add_index "kerayserat", ["yhtio", "nro", "tila", "laatija"], name: "yhtio_nro_tila_laatija"
  add_index "kerayserat", ["yhtio", "nro"], name: "yhtio_nro"
  add_index "kerayserat", ["yhtio", "otunnus"], name: "yhtio_otunnus"
  add_index "kerayserat", ["yhtio", "sscc"], name: "yhtio_sscc"
  add_index "kerayserat", ["yhtio", "sscc_ulkoinen"], name: "yhtio_sscculkoinen"
  add_index "kerayserat", ["yhtio", "tilausrivi"], name: "yhtio_tilausrivi"
  ...
  add_index "keraysvyohyke", ["yhtio"], name: "yhtio"
  ...
  add_index "korvaavat", ["yhtio", "id"], name: "yhtio_id"
  add_index "korvaavat", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  ...
  create_table "kuka", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "kieli",                         limit: 2,                            default: "",  null: false
    t.string   "kuka",                          limit: 10,                           default: "",  null: false
    t.string   "laatija",                       limit: 10,                           default: "",  null: false
  ...
  add_index "kuka", ["session"], name: "session_index"
  add_index "kuka", ["yhtio", "kesken"], name: "yhtio_kesken"
  add_index "kuka", ["yhtio", "kuka"], name: "kuka_index", unique: true
  add_index "kuka", ["yhtio", "myyja"], name: "yhtio_myyja"

  create_table "kulunvalvonta", primary_key: "tunnus", force: true do |t|
    t.datetime "aika"
    t.datetime "hyvaksytty"
    t.datetime "luontiaika"
    t.datetime "muokattu"
    t.datetime "viety"
    t.integer  "minuuttimaara",            default: 0,  null: false
    t.integer  "otunnus",                  default: 0,  null: false
    t.string   "hyvaksyja",     limit: 10, default: "", null: false
    t.string   "kuka",          limit: 10, default: "", null: false
    t.string   "laatija",       limit: 10, default: "", null: false
    t.string   "muokkaaja",     limit: 10, default: "", null: false
  ...
  add_index "lahdot", ["yhtio", "aktiivi", "liitostunnus"], name: "yhtio_aktiivi_liitostunnus"
  add_index "lahdot", ["yhtio", "aktiivi", "pvm"], name: "yhtio_aktiivi_pvm"
  ...
  create_table "lasku", primary_key: "tunnus", force: true do |t|
    ...
    t.datetime "h4time"
    t.datetime "h5time"
    t.datetime "kerayspvm"
    t.datetime "lahetepvm"
    t.datetime "laskutettu"
    t.datetime "luontiaika"
    t.datetime "maksuaika"
    t.datetime "popvm"
    t.decimal  "alv",                                          precision: 5,  scale: 2, default: 0.0,        null: false
    ...
    t.string   "hyvak1",                           limit: 10,                           default: "",         null: false
    t.string   "hyvak2",                           limit: 10,                           default: "",         null: false
    t.string   "hyvak3",                           limit: 10,                           default: "",         null: false
    t.string   "hyvak4",                           limit: 10,                           default: "",         null: false
    t.string   "hyvak5",                           limit: 10,                           default: "",         null: false
    t.string   "hyvaksyja_nyt",                    limit: 10,                           default: "",         null: false
    ...
    t.string   "kuljetus",                         limit: 35,                           default: "",         null: false
    t.string   "laatija",                          limit: 10,                           default: "",         null: false
    t.string   "lahetetyyppi",                     limit: 50,                           default: "",         null: false
    t.string   "laskuttaja",                       limit: 10,                           default: "",         null: false
    t.string   "maa",                              limit: 2,                            default: "",         null: false
    t.string   "maa_alkupera",                     limit: 2,                            default: "",         null: false
    t.string   "maa_lahetys",                      limit: 2,                            default: "",         null: false
    t.string   "maa_maara",                        limit: 2,                            default: "",         null: false
    t.string   "maksaja",                          limit: 10,                           default: "",         null: false
    ...
    t.string   "tilausvahvistus",                  limit: 5,                            default: "",         null: false
  ...
  add_index "lasku", ["nimi"], name: "asiakasnimi"
  add_index "lasku", ["toim_nimi"], name: "asiakastoim_nimi"
  add_index "lasku", ["yhtio", "alatila"], name: "alatila_index"
  add_index "lasku", ["yhtio", "asiakkaan_tilausnumero"], name: "yhtio_asiakkaan_tilausnumero"
  add_index "lasku", ["yhtio", "hyvaksyja_nyt"], name: "yhtio_hyvaksyjanyt"
  add_index "lasku", ["yhtio", "jaksotettu"], name: "yhtio_jaksotettu"
  add_index "lasku", ["yhtio", "laskunro"], name: "lasno_index"
  add_index "lasku", ["yhtio", "liitostunnus"], name: "yhtio_liitostunnus"
  add_index "lasku", ["yhtio", "tila", "alatila"], name: "tila_index"
  add_index "lasku", ["yhtio", "tila", "factoringsiirtonumero"], name: "factoring"
  add_index "lasku", ["yhtio", "tila", "kerayslista"], name: "yhtio_tila_kerayslista"
  add_index "lasku", ["yhtio", "tila", "laskunro"], name: "yhtio_tila_laskunro"
  add_index "lasku", ["yhtio", "tila", "liitostunnus", "tapvm"], name: "yhtio_tila_liitostunnus_tapvm"
  add_index "lasku", ["yhtio", "tila", "luontiaika"], name: "yhtio_tila_luontiaika"
  add_index "lasku", ["yhtio", "tila", "mapvm"], name: "yhtio_tila_mapvm"
  add_index "lasku", ["yhtio", "tila", "olmapvm"], name: "yhtio_tila_olmapvm"
  add_index "lasku", ["yhtio", "tila", "summa"], name: "yhtio_tila_summa"
  add_index "lasku", ["yhtio", "tila", "summa_valuutassa"], name: "yhtio_tila_summavaluutassa"
  add_index "lasku", ["yhtio", "tila", "tapvm"], name: "yhtio_tila_tapvm"
  add_index "lasku", ["yhtio", "tila", "vienti", "kohdistettu"], name: "kohdistus_index"
  add_index "lasku", ["yhtio", "tila", "ytunnus", "tapvm"], name: "yhtio_tila_ytunnus_tapvm"
  add_index "lasku", ["yhtio", "toimitustavan_lahto"], name: "yhtio_lahto"
  add_index "lasku", ["yhtio", "tunnusnippu"], name: "yhtio_tunnusnippu"
  add_index "lasku", ["yhtio", "vanhatunnus"], name: "yhtio_vanhatunnus"
  add_index "lasku", ["yhtio", "ytunnus"], name: "yhtio_ytunnus"

  create_table "laskun_lisatiedot", primary_key: "tunnus", force: true do |t|
    t.date     "rahlaskelma_ekaerpcm"
    t.date     "sopimus_alkupvm"
    t.date     "sopimus_loppupvm"
    t.date     "vakuutushak_alkamispaiva"
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    ...
    t.string   "laskutus_postitp",                         limit: 60,                          default: "",  null: false
    t.string   "muuttaja",                                 limit: 10,                          default: "",  null: false
    t.string   "projektipaallikko",                        limit: 10,                          default: "",  null: false
  ...
  add_index "laskun_lisatiedot", ["yhtio", "otunnus"], name: "yhtio_otunnus", unique: true
  ...
  add_index "liitetiedostot", ["yhtio", "liitos", "liitostunnus"], name: "yhtio_liitos_liitostunnus"
  ...
  add_index "maat", ["koodi", "nimi"], name: "koodi_nimi"
  add_index "maat", ["koodi", "ryhma_tunnus"], name: "koodi_ryhma", unique: true
  ...
  create_table "maksuehto", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "factoring",          limit: 10,                         default: "",  null: false
  ...
  create_table "maksupositio", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "luonut",      limit: 20,                           default: "",  null: false
  ...
  create_table "messenger", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "kuka",          limit: 10, default: "", null: false
    t.string   "status",        limit: 1,  default: "", null: false
    t.string   "vastaanottaja", limit: 10, default: "", null: false
    t.string   "yhtio",         limit: 5,  default: "", null: false
    t.text     "viesti"
  end

  add_index "messenger", ["yhtio", "kuka", "status"], name: "yhtio_kuka_status"
  add_index "messenger", ["yhtio", "vastaanottaja", "status"], name: "yhtio_vastaanottaja_status"
  ...
  create_table "muisti", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "kuka",       limit: 10, default: "", null: false
    t.string   "laatija",    limit: 10, default: "", null: false
    t.string   "muokannut",  limit: 10, default: "", null: false
  ...
  add_index "muisti", ["yhtio", "kuka", "haku", "nimi", "var"], name: "haut", unique: true
  ...
  add_index "oikeu", ["yhtio", "kuka", "sovellus", "nimi", "alanimi"], name: "oikeudet_index", unique: true
  add_index "oikeu", ["yhtio", "kuka", "sovellus"], name: "sovellus_index"
  add_index "oikeu", ["yhtio", "sovellus", "nimi", "alanimi"], name: "menut_index"
  ...
  add_index "pakkaus", ["yhtio", "pakkaus", "pakkauskuvaus"], name: "yhtio_pakkaus_pakkauskuvaus"
  ...
  add_index "panttitili", ["yhtio", "status", "myyntipvm"], name: "yhtio_status_myyntipvm"
  add_index "panttitili", ["yhtio", "tuoteno", "asiakas", "status"], name: "yhtio_tuoteno_asiakas_status"
  add_index "panttitili", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  ...
  add_index "perusalennus", ["yhtio", "ryhma"], name: "yhtio_ryhma", unique: true
  ...
  add_index "puun_alkio", ["yhtio", "laji", "liitos"], name: "yhtio_laji_liitos"
  add_index "puun_alkio", ["yhtio", "laji", "puun_tunnus"], name: "yhtio_laji_puun_tunnus"
  add_index "puun_alkio", ["yhtio", "liitos", "laji", "puun_tunnus", "kieli"], name: "yhtio_laji_liitos_puuntunnus_kieli", unique: true
  ...
  create_table "rahtikirjanumero", primary_key: "tunnus", force: true do |t|
    t.datetime "kaytettyaika"
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    t.string   "kayttaja",      limit: 10,  default: "", null: false
    t.string   "laatija",       limit: 10,  default: "", null: false
    t.string   "muuttaja",      limit: 10,  default: "", null: false
  ...
  add_index "rahtikirjat", ["yhtio", "otsikkonro"], name: "otsikko_index"
  add_index "rahtikirjat", ["yhtio", "rahtikirjanro"], name: "rahtikirjanro", length: {"yhtio"=>nil, "rahtikirjanro"=>150}
  ...
  add_index "sarjanumeroseuranta", ["yhtio", "lisatieto"], name: "yhtio_lisatieto", length: {"yhtio"=>nil, "lisatieto"=>100}
  add_index "sarjanumeroseuranta", ["yhtio", "perheid"], name: "perheid"
  add_index "sarjanumeroseuranta", ["yhtio", "sarjanumero"], name: "yhtio_sarjanumero"
  add_index "sarjanumeroseuranta", ["yhtio", "tuoteno", "myyntirivitunnus"], name: "yhtio_myyntirivi"
  add_index "sarjanumeroseuranta", ["yhtio", "tuoteno", "ostorivitunnus"], name: "yhtio_ostorivi"
  add_index "sarjanumeroseuranta", ["yhtio", "tuoteno", "sarjanumero"], name: "yhtio_tuoteno_sarjanumero"
  add_index "sarjanumeroseuranta", ["yhtio", "tuoteno", "siirtorivitunnus"], name: "yhtio_siirtorivitunnus"
  add_index "sarjanumeroseuranta", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  ...
  add_index "suoritus", ["ltunnus"], name: "tositerivit_index"
  add_index "suoritus", ["yhtio", "asiakas_tunnus"], name: "yhtio_asiakastunnus"
  add_index "suoritus", ["yhtio", "kohdpvm"], name: "yhtio_kohdpvm"
  add_index "suoritus", ["yhtio", "viite"], name: "yhtio_viite"

  create_table "suorituskykyloki", primary_key: "tunnus", force: true do |t|
    t.datetime "luontiaika"
    t.datetime "suoritusalku"
    t.datetime "suoritusloppu"
  ...
  add_index "suorituskykyloki", ["yhtio", "luontiaika"], name: "yhtio_luontiaika"
  add_index "suorituskykyloki", ["yhtio", "skripti", "luontiaika"], name: "yhtio_skripti_luontiaika"
  ...
  create_table "suuntalavat", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "keikkatunnus",       limit: 150,                          default: "0", null: false
    t.string   "laatija",            limit: 10,                           default: "",  null: false
  ...
  add_index "suuntalavat", ["yhtio", "tila", "keraysvyohyke", "kaytettavyys"], name: "yhtio_tila_keraysvyohyke_kaytettavyys"
  add_index "suuntalavat", ["yhtio", "tila", "keraysvyohyke", "keikkatunnus"], name: "yhtio_tila_keraysvyohyke_keikkatunnus"
  ...
  add_index "suuntalavat_saapuminen", ["yhtio", "suuntalava", "saapuminen"], name: "suuntalavat_saapuminen"
  ...
  add_index "tallennetut_parametrit", ["yhtio", "kuka", "sovellus", "nimitys"], name: "muisti", unique: true
  ...
  add_index "tapahtuma", ["yhtio", "laadittu", "hyllyalue", "hyllynro"], name: "yhtio_laadittu_hyllyalue_hyllynro"
  add_index "tapahtuma", ["yhtio", "laji", "rivitunnus"], name: "yhtio_laji_rivitunnus"
  add_index "tapahtuma", ["yhtio", "laji", "tuoteno"], name: "yhtio_laji_tuoteno"
  add_index "tapahtuma", ["yhtio", "tuoteno", "laadittu"], name: "yhtio_tuote_laadittu"

  create_table "taric_veroperusteet", primary_key: "tunnus", force: true do |t|
    t.date    "voim_alkupvm"
    t.date    "voim_loppupvm"
  ...
  add_index "taric_veroperusteet", ["laji", "nimike", "maa_ryhma"], name: "nimike_index"
  add_index "taric_veroperusteet", ["laji", "toimenpide_id"], name: "fyysinen_avain_index"
  ...
  add_index "taso", ["yhtio", "tyyppi", "taso"], name: "yhtio_tyyppi_taso_index", unique: true

  create_table "tilausrivi", primary_key: "tunnus", force: true do |t|
    t.boolean  "varastoon",                                                  default: true, null: false
    t.date     "kerayspvm"
    t.date     "laskutettuaika"
    t.date     "toimaika"
    t.datetime "kerattyaika"
    t.datetime "laadittu"
    t.datetime "toimitettuaika"
    t.decimal  "ale1",                              precision: 5,  scale: 2, default: 0.0,  null: false
    t.decimal  "ale2",                              precision: 5,  scale: 2, default: 0.0,  null: false
    t.decimal  "ale3",                              precision: 5,  scale: 2, default: 0.0,  null: false
    t.decimal  "alv",                               precision: 5,  scale: 2, default: 0.0,  null: false
    ...
    t.integer  "tuote_tunnus",                                               default: 0,    null: false
    t.integer  "uusiotunnus",                                                default: 0,    null: false
    t.string   "hyllyalue",             limit: 5,                            default: "",   null: false
    t.string   "hyllynro",              limit: 5,                            default: "",   null: false
    t.string   "hyllytaso",             limit: 5,                            default: "",   null: false
    ...
    t.string   "keratty",               limit: 10,                           default: "",   null: false
    t.string   "laatija",               limit: 10,                           default: "",   null: false
    t.string   "laskutettu",            limit: 10,                           default: "",   null: false
    t.string   "netto",                 limit: 1,                            default: "",   null: false
    t.string   "nimitys",               limit: 100,                          default: "",   null: false
    t.string   "toimitettu",            limit: 10,                           default: "",   null: false
    t.string   "tuoteno",               limit: 60,                           default: "",   null: false
    t.string   "tyyppi",                limit: 1,                            default: "",   null: false
  ...
  add_index "tilausrivi", ["yhtio", "laadittu"], name: "yhtio_laadittu"
  add_index "tilausrivi", ["yhtio", "otunnus"], name: "yhtio_otunnus"
  add_index "tilausrivi", ["yhtio", "perheid2"], name: "yhtio_perheid2"
  add_index "tilausrivi", ["yhtio", "suuntalava"], name: "suuntalava_index"
  add_index "tilausrivi", ["yhtio", "tyyppi", "kerattyaika"], name: "yhtio_tyyppi_kerattyaika"
  add_index "tilausrivi", ["yhtio", "tyyppi", "laskutettuaika"], name: "yhtio_tyyppi_laskutettuaika"
  add_index "tilausrivi", ["yhtio", "tyyppi", "osasto", "try", "laadittu"], name: "yhtio_tyyppi_osasto_try_laadittu"
  add_index "tilausrivi", ["yhtio", "tyyppi", "osasto", "try", "laskutettuaika"], name: "yhtio_tyyppi_osasto_try_laskutettuaika"
  add_index "tilausrivi", ["yhtio", "tyyppi", "toimitettuaika"], name: "yhtio_tyyppi_toimitettuaika"
  add_index "tilausrivi", ["yhtio", "tyyppi", "tuoteno", "laadittu"], name: "yhtio_tyyppi_tuoteno_laadittu"
  add_index "tilausrivi", ["yhtio", "tyyppi", "tuoteno", "laskutettuaika"], name: "yhtio_tyyppi_tuoteno_laskutettuaika"
  add_index "tilausrivi", ["yhtio", "tyyppi", "tuoteno", "varattu"], name: "yhtio_tyyppi_tuoteno_varattu"
  add_index "tilausrivi", ["yhtio", "tyyppi", "var", "keratty", "kerattyaika", "uusiotunnus"], name: "yhtio_tyyppi_var_keratty_kerattyaika_uusiotunnus"
  add_index "tilausrivi", ["yhtio", "uusiotunnus"], name: "uusiotunnus_index"
  ...
  create_table "tilausrivin_lisatiedot", primary_key: "tunnus", force: true do |t|
    ...
    t.date     "sopimus_alkaa"
    t.date     "sopimus_loppuu"
    t.date     "suoratoimitettuaika"
    t.datetime "luontiaika"
    t.datetime "muutospvm"
  ...
  add_index "tilausrivin_lisatiedot", ["yhtio", "tilausrivilinkki"], name: "tilausrivilinkki"
  add_index "tilausrivin_lisatiedot", ["yhtio", "tilausrivitunnus"], name: "tilausrivitunnus", unique: true
  add_index "tilausrivin_lisatiedot", ["yhtio", "vanha_otunnus"], name: "yhtio_vanhaotunnus"

  create_table "tili", primary_key: "tunnus", force: true do |t|
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    t.decimal  "oletus_alv",                      precision: 5, scale: 2, default: 0.0, null: false
    t.integer  "kohde",                                                   default: 0,   null: false
    t.integer  "kustp",                                                   default: 0,   null: false
    t.integer  "projekti",                                                default: 0,   null: false
  ...
  add_index "tili", ["nimi"], name: "nimi"
  add_index "tili", ["yhtio", "tilino"], name: "tili_index"

  create_table "tilikaudet", primary_key: "tunnus", force: true do |t|
    t.date     "tilikausi_alku"
    t.date     "tilikausi_loppu"
    t.datetime "luontiaika"
    t.datetime "muutospvm"
  ...
  create_table "tiliointi", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "korjattu",         limit: 10,                          default: "",  null: false
    t.string   "laatija",          limit: 10,                          default: "",  null: false
  ...
  add_index "tiliointi", ["ltunnus"], name: "tositerivit_index"
  add_index "tiliointi", ["yhtio", "aputunnus"], name: "aputunnus_index"
  add_index "tiliointi", ["yhtio", "tapvm", "tilino"], name: "yhtio_tapvm_tilino"
  add_index "tiliointi", ["yhtio", "tilino", "tapvm"], name: "yhtio_tilino_tapvm"
  add_index "tiliointi", ["yhtio", "tosite"], name: "tosite_index"
  ...
  add_index "tiliotedata", ["aineisto"], name: "aineisto_index"
  add_index "tiliotedata", ["yhtio", "alku"], name: "yhtio_alku"
  add_index "tiliotedata", ["yhtio", "perheid"], name: "perheid_index"
  add_index "tiliotedata", ["yhtio", "tilino", "alku"], name: "yhtio_tilino_alku"
  add_index "tiliotedata", ["yhtio", "tilino", "tyyppi", "tieto"], name: "yhtio_tilino_tyyppi_tieto", length: {"yhtio"=>nil, "tilino"=>nil, "tyyppi"=>nil, "tieto"=>150}
  add_index "tiliotedata", ["yhtio", "tiliointitunnus"], name: "yhtio_tiliointitunnus"
  ...
  add_index "todo", ["yhtio", "kuittaus", "tekija"], name: "yhtio_kuittaus_tekija", length: {"yhtio"=>nil, "kuittaus"=>4, "tekija"=>nil}
  ...
  create_table "toimi", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "nimi",                     limit: 60,                          default: "",  null: false
    t.string   "nimitark",                 limit: 60,                          default: "",  null: false
    t.string   "oletus_hyvak1",            limit: 10,                          default: "",  null: false
    t.string   "oletus_hyvak2",            limit: 10,                          default: "",  null: false
    t.string   "oletus_hyvak3",            limit: 10,                          default: "",  null: false
    t.string   "oletus_hyvak4",            limit: 10,                          default: "",  null: false
    t.string   "oletus_hyvak5",            limit: 10,                          default: "",  null: false
  ...
  add_index "toimi", ["yhtio", "toimittajanro"], name: "toimittajanro_index"
  add_index "toimi", ["yhtio", "ytunnus"], name: "ytunnus_index"
  ...
  add_index "toimittajaalennus", ["yhtio", "toimittaja", "ryhma"], name: "yhtio_toimittaja_ryhma"
  add_index "toimittajaalennus", ["yhtio", "toimittaja", "tuoteno"], name: "yhtio_toimittaja_tuoteno"
  add_index "toimittajaalennus", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  add_index "toimittajaalennus", ["yhtio", "ytunnus", "ryhma"], name: "yhtio_ytunnus_ryhma"
  add_index "toimittajaalennus", ["yhtio", "ytunnus", "tuoteno"], name: "yhtio_ytunnus_tuoteno"
  ...
  add_index "toimittajahinta", ["yhtio", "toimittaja", "ryhma"], name: "yhtio_toimittaja_ryhma"
  add_index "toimittajahinta", ["yhtio", "toimittaja", "tuoteno"], name: "yhtio_toimittaja_tuoteno"
  add_index "toimittajahinta", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  add_index "toimittajahinta", ["yhtio", "ytunnus", "ryhma"], name: "yhtio_ytunnus_ryhma"
  add_index "toimittajahinta", ["yhtio", "ytunnus", "tuoteno"], name: "yhtio_ytunnus_tuoteno"
  ...
  add_index "toimitustapa", ["yhtio", "selite"], name: "selite_index"
  add_index "toimitustapa", ["yhtio", "selite"], name: "yhtio_selite", unique: true
  ...
  add_index "tullinimike", ["cn"], name: "tullinimike_cn"

  create_table "tuote", primary_key: "tunnus", force: true do |t|
    t.date     "epakurantti100pvm"
    t.date     "epakurantti25pvm"
    t.date     "epakurantti50pvm"
    t.date     "epakurantti75pvm"
    t.date     "vihapvm"
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    t.decimal  "alv",                                      precision: 5,  scale: 2, default: 0.0, null: false
    ...
    t.string   "kuljetusohje",                 limit: 100,                          default: "",  null: false
    t.string   "laatija",                      limit: 10,                           default: "",  null: false
  ...
  add_index "tuote", ["nimitys"], name: "nimitys"
  add_index "tuote", ["tuoteno"], name: "tuoteno"
  add_index "tuote", ["yhtio", "aleryhma"], name: "yhtio_aleryhma"
  add_index "tuote", ["yhtio", "eankoodi"], name: "yhtio_eankoodi_index"
  add_index "tuote", ["yhtio", "myyjanro"], name: "yhtio_myyjanro"
  add_index "tuote", ["yhtio", "osasto", "try"], name: "osasto_try_index"
  add_index "tuote", ["yhtio", "status", "osasto", "try"], name: "yhtio_status_osasto_try"
  add_index "tuote", ["yhtio", "try"], name: "yhtio_try_index"
  add_index "tuote", ["yhtio", "tullinimike1", "tullinimike2"], name: "yhtio_tullinimike"
  add_index "tuote", ["yhtio", "tuotemerkki"], name: "yhtio_tuotemerkki"
  add_index "tuote", ["yhtio", "tuoteno"], name: "tuoteno_index", unique: true
  add_index "tuote", ["yhtio", "tuotetyyppi", "status"], name: "yhtio_tuotetyyppi_status"
  add_index "tuote", ["yhtio"], name: "toituono_index"
  ...
  create_table "tuotepaikat", primary_key: "tunnus", force: true do |t|
    t.datetime "inventointiaika"
    t.datetime "inventointilista_aika"
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    t.datetime "saldoaika"
    t.decimal  "halytysraja",                      precision: 12, scale: 2, default: 0.0, null: false
  ...
  add_index "tuotepaikat", ["yhtio", "inventointilista"], name: "yhtio_inventointilista"
  add_index "tuotepaikat", ["yhtio", "inventointilista_aika"], name: "yhtio_inventointilista_aika"
  add_index "tuotepaikat", ["yhtio", "saldoaika", "saldo"], name: "saldo_index"
  add_index "tuotepaikat", ["yhtio", "tuoteno", "hyllyalue", "hyllynro", "hyllyvali", "hyllytaso"], name: "yhtio_tuoteno_paikka", unique: true
  add_index "tuotepaikat", ["yhtio", "tuoteno"], name: "tuote_index"

  create_table "tuoteperhe", primary_key: "tunnus", force: true do |t|
    t.datetime "luontiaika"
    t.datetime "muutospvm"
    t.decimal  "alekerroin",              precision: 9,  scale: 8, default: 1.0, null: false
    t.decimal  "hintakerroin",            precision: 9,  scale: 8, default: 1.0, null: false
    t.decimal  "kerroin",                 precision: 12, scale: 8, default: 1.0, null: false
    t.string   "ei_nayteta",   limit: 1,                           default: "",  null: false
  ...
  add_index "tuoteperhe", ["yhtio", "tyyppi", "isatuoteno"], name: "yhtio_tyyppi_isatuoteno"
  add_index "tuoteperhe", ["yhtio", "tyyppi", "tuoteno"], name: "yhtio_tyyppi_tuoteno"
  ...
  add_index "tuotteen_alv", ["yhtio", "maa", "tuoteno"], name: "yhtio_maa_tuoteno", unique: true
  ...
  add_index "tuotteen_avainsanat", ["yhtio", "kieli", "laji", "tuoteno"], name: "yhtio_kieli_laji_tuoteno"
  add_index "tuotteen_avainsanat", ["yhtio", "kieli", "tuoteno"], name: "yhtio_kieli_tuoteno"
  ...
  add_index "tuotteen_toimittajat", ["yhtio", "toim_tuoteno"], name: "yhtio_toimtuoteno"
  add_index "tuotteen_toimittajat", ["yhtio", "toimittaja"], name: "yhtio_toimittaja"
  add_index "tuotteen_toimittajat", ["yhtio", "tuoteno", "liitostunnus"], name: "yhtio_tuoteno_liitostunnus", unique: true
  add_index "tuotteen_toimittajat", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  ...
  add_index "tuotteen_toimittajat_tuotenumerot", ["yhtio", "toim_tuoteno_tunnus", "tuoteno", "viivakoodi"], name: "tuotteen_toimittajat_tuotenumerot", unique: true
  ...
  add_index "valuu", ["yhtio", "nimi"], name: "yhtio_nimi", unique: true
  ...
  add_index "valuu_historia", ["kotivaluutta", "valuutta", "kurssipvm"], name: "kotivaluutta_valkoodi_kurssipvm", unique: true
  ...
  add_index "varaston_hyllypaikat", ["yhtio", "hyllyalue", "hyllynro", "hyllyvali", "hyllytaso"], name: "yhtio_paikka", unique: true
  add_index "varaston_hyllypaikat", ["yhtio", "varasto", "korkeus", "leveys", "syvyys", "maksimitaakka"], name: "yhtio_varasto_mitat"
  ...
  add_index "varastopaikat", ["yhtio", "maa"], name: "yhtio_maa"
  ...
  add_index "vastaavat", ["yhtio", "id"], name: "yhtio_id"
  add_index "vastaavat", ["yhtio", "tuoteno"], name: "yhtio_tuoteno"
  ...
  create_table "yhtio", primary_key: "tunnus", force: true do |t|
    t.date     "myyntireskontrakausi_alku"
    t.date     "myyntireskontrakausi_loppu"
    t.date     "ostoreskontrakausi_alku"
    t.date     "ostoreskontrakausi_loppu"
    t.date     "tilikausi_alku"
    t.date     "tilikausi_loppu"
    t.datetime "luontiaika"
    t.datetime "muutospvm"
  ...
  add_index "yhtio", ["yhtio"], name: "yhtio_index"

  create_table "yhtion_parametrit", primary_key: "tunnus", force: true do |t|
    t.datetime "luontiaika"
    t.datetime "maventa_aikaleima"
    t.datetime "muutospvm"
    ...
    t.float    "viitemaksujen_kohdistus_sallittu_heitto",                                       default: 0.0, null: false
    ...
    t.string   "tuotteen_oletuspaikka",                    limit: 25,                           default: "",  null: false
  ...
  add_index "yhtion_parametrit", ["yhtio"], name: "yhtio_index"
  ...
  add_index "yhtion_toimipaikat", ["yhtio"], name: "yhtio_index"
  ...
  create_table "yriti", primary_key: "tunnus", force: true do |t|
    ...
    t.string   "hyvak",                 limit: 10,                          default: "",  null: false
  ...
  add_index "yriti", ["yhtio", "tilino"], name: "yhtio_tilino", unique: true
